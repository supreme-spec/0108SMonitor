    ...
    <div className="flex flex-col h-screen overflow-hidden bg-kraken-base">
      ...
      {page === 'chronicle' && (
        <div className="fixed inset-0 z-40 flex items-end pointer-events-none">
          <div className="absolute inset-y-0 right-0 left-[80px] bg-black/60 pointer-events-auto" onClick={() => setPage(prevPage)} />
          <div className="relative pointer-events-auto w-[calc(100%-80px)] h-[40vh] bg-kraken-panel border-t border-kraken-border rounded-t-xl animate-slide-up z-50 flex flex-col shadow-[0_-4px_30px_rgba(0,0,0,0.5)]">
